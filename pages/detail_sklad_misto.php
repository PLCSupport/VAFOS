...
// Přepnutí na databázi z session
$conn->exec("USE " . $dbName);

// Přiřazení LocationID na základě session
$locationID = $_SESSION['department'];

// SQL dotaz pro získání skladových jednotek na daném místě, filtrovaných dle LocationID
$sql = "SELECT 
            StockUnitCode,
            StockUnitSSCC,
            SkladoveMistoName,
...
// SQL dotaz pro spočítání počtu položek na skladovém místě, filtrovaných dle LocationID
...
$stmt_count->bindParam(':locationID', $locationID);
$stmt_count->execute();
...
<head>
  ...
  <link rel="stylesheet" href="https://vafos.vafo.cz/vafosapppro/css/detail_sklad_misto.css">
  <style>
    .carousel-indicators {
