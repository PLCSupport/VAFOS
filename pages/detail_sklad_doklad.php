...
if (!isset($_SESSION['barcode'])) {
    ...
    header("Location: https://vafos.vafo.cz/vafosapppro/vafosapp/index.php");
    exit();
}
...
<head>
  ...
  <link rel="stylesheet" href="https://vafos.vafo.cz/vafosapppro/css/detail_sklad_doklad.css">
