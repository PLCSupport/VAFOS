$(document).ready(function() {
    ...
    function checkBarcodeTypeAndRedirect(barcode) {
        $.ajax({
            url: 'https://vafos.vafo.cz/vafosapppro/check_barcode_type.php', 
            type: 'POST',
                ...
                switch(barcodeType) {
                    ...
                    case 'StockUnitSSCC':
                        if (!currentUrl.includes('detail_sklad_doklad.php')) {
                            window.location.href = 'https://vafos.vafo.cz/vafosapppro/pages/detail_sklad_jednotka.php?barcode=' + encodeURIComponent(barcode);
                        }
                        break;
                    case 'StockReceiptCode':
                        window.location.href = 'https://vafos.vafo.cz/vafosapppro/pages/detail_sklad_doklad.php?barcode=' + encodeURIComponent(barcode);
                        break;
                    case 'SkladoveMistoName':
                    case 'SkladoveMistoNazev':
                        if (!currentUrl.includes('detail_sklad_jednotka.php')) {
                            window.location.href = 'https://vafos.vafo.cz/vafosapppro/pages/detail_sklad_misto.php?barcode=' + encodeURIComponent(barcode);
                        }
                        break;
                }
            },
